...
Thank you for considering contributing to ParlAT! This document outlines
how to propose changes to this package.
...
- Include a clear description of the change and the motivation behind
  it.
- Ensure
...
<https://github.com/werkstattcodes/ParlAT/issues> with a minimal
reproducible example.

## Code of Conduct

Please be respectful and constructive in all interactions. We are
committed to providing a welcoming and inclusive experience for
everyone.
