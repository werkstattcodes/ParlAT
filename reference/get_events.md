...
#> {"DATERANGE":["2024-10-23T22:00:00.000Z","2026-03-26T22:59:59.000Z"],"GREMIUM":["Nationalrat"]} 
#> https://www.parlament.gv.at/aktuelles/termine/index.html?TERMIN_01DATERANGE=2024-10-23T22:00:00.000Z&TERMIN_01DATERANGE=2026-03-26T22:59:59.000Z&TERMIN_01GREMIUM=Nationalrat
#> [1] 590
  dplyr::glimpse(events)
#> Rows: 590
#> Columns: 15
...
#> $ date_time_end   <dttm> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ title           <chr> "73.&nbsp;Sitzung des Nationalrates", "Galeriebesuch 9…
#> $ event_type      <chr> "Plenarsitzung", "Besuch einer Plenarsitzung", "Besuch…
#> $ location        <chr> "Nationalratssaal", "Parlament", "Parlament", "Parlame…
#> $ topic           <chr> NA, "[\"Parlament und Demokratie\"]", "[\"Parlament un…
#> $ institution     <chr> "Nationalrat", "Nationalrat", "Nationalrat", "National…
#> $ media_relevance <chr> "J", "N", "N", "N", "N", "N", "N", "N", "N", "N", "N",…
#> $ group           <chr> NA, "N", "N", "N", "N", "N", "N", "N", "N", "N", "N", …
#> $ view            <chr> "[\"S\"]", "[\"S\"]", "[\"S\"]", "[\"S\"]", "[\"S\"]",…
#> $ fully_booked    <chr> NA, NA, "59/60 frei", NA, NA, NA, NA, NA, NA, NA, NA, …
#> $ registration    <chr> NA, NA, "{\"href\":\"/erleben/fuehrungen/252020?select…
#> $ livestream_url  <chr> "<a href=\"/aktuelles/mediathek/XXVIII/NRSITZ/73\" tit…
#> $ language        <chr> NA, "[\"Deutsch\"]", "[\"Deutsch\"]", "[\"Deutsch\"]",…
#> $ link            <chr> "/gegenstand/XXVIII/NRSITZ/73", "/erleben/fuehrungen/2…
# }
```
