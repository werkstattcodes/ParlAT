...
and their mandates, or parliamentary meetings. The package is designed
...
at the package’s [github
repo](https://github.com/werkstattcodes/ParlAT/issues).
...
The Open Data offer of the Austrian Parliament comprises [25
datasets](https://www.parlament.gv.at/recherchieren/open-data/daten-und-lizenz/index.html)
which are made available - with some exceptions - under a CC BY 4.0
license. These datasets are accessible via the search interface of the
Austrian Parliament website as well as by directly querying the
Parliament’s API. ParlAT seeks to facilitate accessing the latter.
...
| Stenographisches Protokolle (Meeting transcripts)                                                                                   | [`get_transcripts()`](https://werkstattcodes.github.io/ParlAT/dev/reference/get_transcripts.md)           |
| Plenarsitzungen (Plenary meetings)                                                                                                  | [`get_plenary_meetings()`](https://werkstattcodes.github.io/ParlAT/dev/reference/get_plenary_meetings.md) |
| Parlamentarier seit 1918 (MPs since 1918)                                                                                           | [`get_mps()`](https://werkstattcodes.github.io/ParlAT/dev/reference/get_mps.md)                           |
...
| Termine (Events)                                                                                                                    | [`get_events()`](https://werkstattcodes.github.io/ParlAT/dev/reference/get_events.md)                     |
| Ausschüsse (Committees)                                                                                                             | [`get_committees()`](https://werkstattcodes.github.io/ParlAT/dev/reference/get_committees.md)             |
