...
#> $ item_number      <chr> "5919", "5914", "5896", "6819", "5724", "5717", "5718…
...
#> $ parl_group       <list> "ÖVP", "NEOS", "ÖVP", "FPÖ", "SPÖ", "SPÖ", "ÖVP", "N…
...
#> $ item_type        <chr> "A", "A", "AA", "A", "A", "A", "AA", "A", "A", "A", "…
#> $ item_number      <chr> "3892", "3922", "372", "3929", "3932", "3931", "374",…
#> $ item_number_type <chr> "3892/A", "3922/A(E)", "AA-372", "3929/A(E)", "3932/A…
#> $ stage            <chr> "2", "5", "5", "3", "3", "3", "5", "5", "5", "2", "3"…
#> $ item_url         <chr> "https://www.parlament.gv.at/gegenstand/XXVII/A/3892"…
#> $ type_doc         <chr> "A", "A(E)", "AA", "A(E)", "A(E)", "A(E)", "AA", "A",…
#> $ type_doc_long    <chr> "Selbständiger Antrag", "Selbständiger Entschließungs…
#> $ subject          <chr> "Einkommensteuergesetz, Änderung", "Maßnahmen zum Erh…
#> $ topics           <list> "Budget und Finanzen", "Verkehr und Infrastruktur", …
#> $ keywords         <list> "Steuern und Gebühren", "Verkehr II. Schienenverkehr…
#> $ eurovoc          <chr> "[\"Steuerwesen\"]", "[\"Schienentransport\"]", "[\"A…
#> $ persons          <list> "83121", <"22847", "30653">, "5684", "51568", "35468…
#> $ parl_group       <list> "NEOS", <"FPÖ", "SPÖ">, "NEOS", "FPÖ", "FPÖ", "FPÖ",…
