...
- "AUB-BR" (Ausschussberichte Bundesrat, Committee Reports Federl
  Council)
...
#> $ date             <date> 2026-09-07, 2026-09-04, 2026-09-03, 2026-08-26, 2026…
#> $ item_type        <chr> "AB", "AB", "AB", "J", "AB", "AB", "AB", "AB", "AB", …
#> $ item_number      <chr> "5919", "5914", "5896", "6819", "5724", "5717", "5720…
#> $ item_number_type <chr> "5919/AB", "5914/AB", "5896/AB", "6819/J", "5724/AB",…
#> $ stage            <chr> "5", "5", "5", "3", "5", "5", "5", "5", "5", "5", "5"…
#> $ item_url         <chr> "https://www.parlament.gv.at/gegenstand/XXVIII/AB/591…
#> $ type_doc         <chr> "AB", "AB", "AB", "J", "AB", "AB", "AB", "AB", "AB", …
#> $ type_doc_long    <chr> "Anfragebeantwortung", "Anfragebeantwortung", "Anfrag…
#> $ subject          <chr> "Koordinations-, Repräsentations- und Sicherheitsaufw…
#> $ topics           <list> <"Außenpolitik", "Europäische Union">, <"Außenpoliti…
#> $ keywords         <list> <"Europäische Integration", "Außenpolitik">, <"Europ…
#> $ eurovoc          <chr> "[\"Europäische Union\",\"Internationale Beziehungen\…
#> $ persons          <list> "5439", "83122", "10778", <"22847", "23963">, "3677"…
#> $ parl_group       <list> "ÖVP", "NEOS", "ÖVP", "FPÖ", "SPÖ", "SPÖ", "NEOS", "…
...
#> $ item_number      <chr> "3932", "3884", "3892", "3922", "3905", "3923", "3931…
#> $ item_number_type <chr> "3932/A(E)", "3884/A(E)", "3892/A", "3922/A(E)", "390…
#> $ stage            <chr> "3", "3", "2", "5", "3", "5", "3", "5", "3", "5", "3"…
#> $ item_url         <chr> "https://www.parlament.gv.at/gegenstand/XXVII/A/3932"…
#> $ type_doc         <chr> "A(E)", "A(E)", "A", "A(E)", "A(E)", "A(E)", "A(E)", …
#> $ type_doc_long    <chr> "Selbständiger Entschließungsantrag", "Selbständiger …
#> $ subject          <chr> "Generalüberholung der Abfertigung Neu zum Schutz der…
#> $ topics           <list> "Arbeit", <"Budget und Finanzen", "Soziales">, "Budg…
#> $ keywords         <list> "Arbeitsrecht I. österreichisches", <"Währung", "Men…
#> $ eurovoc          <chr> "[\"Arbeitsrecht\"]", "[\"Mensch mit Behinderung\",\"…
#> $ persons          <list> "35468", "5638", "83121", <"22847", "30653">, "5685"…
#> $ parl_group       <list> "FPÖ", "SPÖ", "NEOS", <"FPÖ", "SPÖ">, "NEOS", <"FPÖ"…
...
#> $ item_type        <chr> "AB", "AB", "III", "III", "AS-BR", "AB", "AB", "AB", …
...
#> $ type_doc         <chr> "AB", "AB", "BRG", "BRG", "AS-BR", "AB", "AB", "AB", …
...
#> $ legis_period     <chr> "XXVIII", "XXVIII", "XXVIII", "XXVIII", "XXVIII", "XX…
#> $ institution      <chr> "NR", "NR", "NR", "NR", "NR", "NR", "NR", "NR", "NR",…
#> $ date             <date> 2026-09-04, 2026-08-05, 2026-07-31, 2026-07-30, 2026…
#> $ item_type        <chr> "J", "J", "J", "J", "J", "J", "J", "J", "J", "J", "J"…
#> $ item_number      <chr> "6846", "6760", "6751", "6746", "6695", "6711", "6657…
#> $ item_number_type <chr> "6846/J", "6760/J", "6751/J", "6746/J", "6695/J", "67…
#> $ stage            <chr> "3", "3", "3", "3", "3", "3", "3", "3", "3", "3", "3"…
#> $ item_url         <chr> "https://www.parlament.gv.at/gegenstand/XXVIII/J/6846…
#> $ type_doc         <chr> "J", "J", "J", "J", "J", "J", "J", "J", "J", "J", "J"…
#> $ type_doc_long    <chr> "Schriftliche Anfrage", "Schriftliche Anfrage", "Schr…
#> $ subject          <chr> "Die sofortige Einstellung jeglicher Integrationsförd…
#> $ topics           <list> <"Außenpolitik", "Budget und Finanzen", "Inneres und…
#> $ keywords         <list> <"Flüchtlinge", "Bundeshaushalt III. Sonstiges">, <"…
#> $ eurovoc          <chr> "[\"Flüchtling\",\"Öffentliche Finanzen und Haushalts…
#> $ persons          <list> <"2996", "20445">, <"20445", "30664">, <"20445", "35…
#> $ parl_group       <list> "FPÖ", "FPÖ", "FPÖ", "GRÜNE", "FPÖ", "FPÖ", "FPÖ", "…
...
#> $ item_number      <chr> "8772", "11", "8178", "8203", "8131", "8156", "7462",…
#> $ item_number_type <chr> "8772/J", "11/IMM", "8178/J", "8203/J", "8131/J", "81…
...
#> ✔ Fetched 5 items
#> Results on the Parliament website:
#> https://www.parlament.gv.at/recherchieren/gegenstaende?FP_001NRBR=NR&FP_001GP_CODE=XXV&FP_001VHG=EU&FP_001VHG2=MTEU
#> Hits: 5
dplyr::glimpse(result)
#> Rows: 5
#> Columns: 16
#> $ legis_period     <chr> "XXV", "XXV", "XXV", "XXV", "XXV"
#> $ institution      <chr> "NR", "NR", "NR", "NR", "NR"
#> $ date             <date> 2017-02-21, 2014-12-04, 2014-07-02, 2014-04-23, 2013-…
#> $ item_type        <chr> "MTEU", "MTEU", "MTEU", "MTEU", "MTEU"
#> $ item_number      <chr> "5", "4", "3", "2", "1"
#> $ item_number_type <chr> "5/MTEU", "4/MTEU", "3/MTEU", "2/MTEU", "1/MTEU"
#> $ stage            <chr> "5", "5", "5", "5", "5"
#> $ item_url         <chr> "https://www.parlament.gv.at/gegenstand/XXV/MTEU/5", …
#> $ type_doc         <chr> "MTEU", "MTEU", "MTEU", "MTEU", "MTEU"
#> $ type_doc_long    <chr> "Mitteilung Ständiger Unterausschuss des Hauptaussch…
#> $ subject          <chr> "Code of conduct on countering illegal hate speech on…
#> $ topics           <list> NA, NA, NA, NA, NA
#> $ keywords         <list> NA, NA, NA, NA, NA
#> $ eurovoc          <chr> NA, NA, NA, NA, NA
#> $ persons          <list> "", "", "", "", ""
#> $ parl_group       <list> "", "", "", "", ""
