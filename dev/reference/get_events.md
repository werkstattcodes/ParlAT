...
#> $ date_time_end   <dttm> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ title           <chr> "250.&nbsp;Sitzung des Nationalrates", "2. Sitzung COF…
...
#> $ date_time_end   <dttm> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ title           <chr> "Galeriebesuch 10-11h", "Galeriebesuch 15-16h", "Galer…
#> $ event_type      <chr> "Besuch einer Plenarsitzung", "Besuch einer Plenarsitz…
#> $ location        <chr> "Parlament", "Parlament", "Parlament", "Parlament", "N…
#> $ topic           <chr> "[\"Parlament und Demokratie\"]", "[\"Parlament und De…
#> $ institution     <chr> "Nationalrat", "Nationalrat", "Nationalrat", "National…
#> $ media_relevance <chr> "N", "N", "N", "N", "J", "N", "N", "N", "N", "N", "N",…
#> $ group           <chr> "N", "N", "N", "N", NA, "N", "N", "N", "N", "N", "N", …
#> $ view            <chr> "[\"S\"]", "[\"S\"]", "[\"S\"]", "[\"S\"]", "[\"S\"]",…
#> $ fully_booked    <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA…
#> $ registration    <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA…
#> $ livestream_url  <chr> NA, NA, NA, NA, "<a href=\"/aktuelles/mediathek/XXVIII…
#> $ language        <chr> "[\"Deutsch\"]", "[\"Deutsch\"]", "[\"Deutsch\"]", "[\…
#> $ link            <chr> "/erleben/fuehrungen/252012", "/erleben/fuehrungen/252…
# }
```
